      ...
      <div class="d-flex">
        ...
        <div class="navbar-brand-box">
          <a href="/" class="logo logo-dark">
            <span class="logo-sm">
              <img src="@/assets/images/logo-sm-dark.png" alt="Jet66ERP" height="40" />
            </span>
            <span class="logo-lg">
              <img src="@/assets/images/logo-dark.png" alt="Jet66ERP" height="36" />
            </span>
          </a>

          <a href="/" class="logo logo-light">
            <span class="logo-sm">
              <img src="@/assets/images/logo-sm-light.png" alt="Jet66ERP" height="40" />
            </span>
            <span class="logo-lg">
              <img src="@/assets/images/logo-light.png" alt="Jet66ERP" height="36" />
            </span>
          </a>
        </div>
